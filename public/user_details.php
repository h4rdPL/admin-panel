                        ...
                        <div class="col-lg-8">
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <p class="text-muted mb-0">
                                                <span class="badge badge-danger">20.03.2022 r.</span>
                                            </p>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <p class="mb-0">Opłacone?</p>
                                        </div>
                                        <div class="col-sm-9">
                                            <p class="text-muted mb-0"><span class="badge badge-success">Tak</span></p>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <p class="text-muted mb-0">
                                                <span class="badge badge-info">20.01.2022 r.</span>
                                            </p>
                                        </div>
                                    </div>
